...
import 'package:farm_gate/data/post_json.dart';
import 'package:farm_gate/data/user_json.dart';
              ...
              children: [
                Text(
                  ...
                  style: TextStyle(
                      fontSize: 25,
                      fontWeight: FontWeight.bold,
                      color: Color.fromARGB(255, 23, 66, 135)),
                ),
                SizedBox(
                  height: 30,
                ),
                      ...
                      Container(
                        ...
                        decoration: BoxDecoration(
                            ...
                            gradient: LinearGradient(colors: [
                              Color.fromARGB(255, 22, 206, 151),
                              Color.fromARGB(255, 86, 228, 108)
                            ])),
                        child: Center(
                          child: Icon(
                            Icons.add,
