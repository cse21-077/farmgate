import 'package:farm_gate/models/boxes.dart';
import 'package:farm_gate/models/transaction.dart';
import 'package:farm_gate/models/transaction_dialog.dart';
...
class _TransactionScreenState extends State<TransactionScreen> {
  ...
  Widget _buildTransactions(BuildContext context, Transaction transaction) {
    ...
    final amount = "P ${transaction.amount}";
    return Padding(
